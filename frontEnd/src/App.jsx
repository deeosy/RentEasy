...
function App() {
  ...
  return (
    <div className="relative mt-[5vh] max-w-[1300px] md:mx-auto rounded-4xl bg-blue-100 h-[90vh] mx-2 overflow-hidden flex flex-col md:flex-row justify-between gap-5">
      <div
